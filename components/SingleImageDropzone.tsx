...
type InputProps = {
  ...
  onUploaded?: (filePath?: string | null) => Promise<void> | void;
  disabled?: boolean;
...
const SingleImageDropzone = React.forwardRef<HTMLInputElement, InputProps>(
  (
    { dropzoneOptions, width, height, value, className, disabled, isSubmitting, onChange },
    ref,
  ) => {
    ...
    return (
      <div className='relative w-full rounded-md'>
        ...
        >
          ...
          {/* Remove Image Icon */}
          {imageUrl && !isSubmitting && !disabled && (
            <div
